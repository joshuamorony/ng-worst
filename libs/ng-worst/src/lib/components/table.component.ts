...
@Directive({
  selector: 'ng-template[worstTableHeader]',
})
export class TableHeaderTemplateDirective<TItem extends object> {
  @Input('worstTableHeader') data!: TItem[] | '';
...
@Directive({
  selector: 'ng-template[worstTableRow]',
})
export class TableRowTemplateDirective<TItem extends object> {
  @Input('worstTableRow') data!: TItem[];
